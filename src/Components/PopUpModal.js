...
export default function PopUpModal(props) {
  ...
  return (
    ...
    >
      <div className="bgLight absolute w-full h-full"/>
        ...
        <div className="relative bg-white rounded-sm shadow ">
          ...
          <div className="p-6 w-96 text-center">
            ...
            <button
              ...
              data-modal-hide="popup-modal"
              type="button"
              className="text-white bg-red-500 hover:bg-red-800  focus:ring-red-300  font-medium rounded-sm text-sm inline-flex  px-16 py-2.5 text-center "
            >
              Ok
            </button>
          </div>
