...
const ContactUs = () => {
  ...
  <div class="relative container px-4 mx-auto">
    ...
    <div class="flex flex-wrap justify-center -mx-4 m-10">
      <div class="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 mb-10 md:mb-0">
        <div class="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
          <div class="max-w-2xs mx-auto text-center">
            ...
            <Link class="relative group inline-block py-4 px-6 text-white font-semibold bg-blue-900 rounded-full overflow-hidden" href="mailto:vijaysurwase1109@gmail.com">
              <div class="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
              <div class="relative flex items-center justify-center">
                <span class="mr-4">Mail Us</span>
                <span>
      ...
      <div class="w-full md:w-1/2 lg:w-auto px-4 xl:px-10">
        <div class="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
          <div class="max-w-2xs mx-auto text-center">
            ...
            <Link href={`tel:+917776862704`} class="relative group inline-block py-4 px-6 text-white font-semibold bg-blue-900 rounded-full overflow-hidden" >
              <div class="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
              <div class="relative flex items-center justify-center">
                <span class="mr-4">Call Us</span>
                <span>
