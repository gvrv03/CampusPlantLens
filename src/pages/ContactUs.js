...
const ContactUs = () => {
  ...
  <div className="relative container px-4 mx-auto">
    <div className="max-w-2xl mx-auto mb-18 text-center">
      <span className="inline-block py-1 px-3 mb-4 text-xs font-semibold text-orange-900 bg-orange-50 rounded-full">READY TO SUPPORT</span>
    ...
    <div className="flex flex-wrap justify-center -mx-4 m-10">
      <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 mb-10 md:mb-0">
        <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
          <div className="max-w-2xs mx-auto text-center">
            <img className="block mx-auto mb-3" src="saturn-assets/images/contact/icon-orange-email.svg" alt=""/>
            ...
            <span className="block text-sm text-orange-900 mb-8">vijaysurwase1109@gmail.com</span>
            <Link className="relative group inline-block py-4 px-6 text-white font-semibold bg-blue-900 rounded-full overflow-hidden" href="mailto:vijaysurwase1109@gmail.com">
              <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
              <div className="relative flex items-center justify-center">
                <span className="mr-4">Mail Us</span>
                <span>
      ...
      <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10">
        <div className="max-w-sm mx-auto h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
          <div className="max-w-2xs mx-auto text-center">
            <img className="block mx-auto mb-3" src="saturn-assets/images/contact/icon-orange-headphones.svg" alt=""/>
            <h5 className="text-2xl font-bold text-gray-900 mb-3">User Service</h5>
            <p className="text-gray-500 mb-3">Contact us to seek help from us, we will help you as soon as possible</p>
            <span className="block text-sm text-blue-900 mb-8">+91 7776862704</span>
            <Link href={`tel:+917776862704`} className="relative group inline-block py-4 px-6 text-white font-semibold bg-blue-900 rounded-full overflow-hidden" >
              <div className="absolute top-0 right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
              <div className="relative flex items-center justify-center">
